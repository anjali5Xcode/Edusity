  ...
  return (
    <div className='contact'>
       <div className="contact-col">
        ...
        <p>We'd love to hear from you! Whether you have questions about our programs, admissions process, or campus life, our team is here to help. You can reach out to us using the contact information below.</p>
       <ul>
        <li> <img src={mail_icon} alt="mail icon" />admissions@university.edu</li>
